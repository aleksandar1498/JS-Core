...
// Test full functionality with multiple tables without validations
let commandsData = [
    [ 'add', 'amazon', null, "Logitech MX Master", "Mouses", "149.99" ],
    [ 'add', 'amazon', null, "Dell XPS 13", "Computers", "999.99" ],
    [ 'add', 'amazon', null, "Oree Board", "Keyboards", "80" ],
    [ 'add', 'ebay', null, "V60 Cherry Dolch", "Keyboards", "105" ],
    [ 'add', 'ebay', null, "Asus Zenbook 13", "Computers", "1035.3400" ],
    [ 'delete', 'amazon', 0 ],
    [ 'add', 'ebay', null, "Oree Board", "Keyboards", "80" ],
    [ 'delete', 'amazon', 1 ],
    [ 'add', 'amazon', null, "V60 Cherry Dolch", "Keyboards", "105" ],
    [ 'delete', 'ebay', 1 ],
    [ 'delete', 'ebay', 0 ]
]
